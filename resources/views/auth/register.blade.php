            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="contact" class="col-md-4 col-form-label text-md-right">{{ __('Contact Number/Tel #') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="igrade" class="col-md-4 col-form-label text-md-right">
                                Intended Grade
                            </label>

                            <div class="col-md-6">
                                <select name="igrade" id="igrade">
